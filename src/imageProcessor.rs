...
/// Byte_Processor, Color_Processor, Float_Processor, Short_Processor
///
/// This abstract class is the superclass for classes that process 
/// the four data types (byte, short, float and RGB) supported by Image_J. 
/// An Image_Processor contains the pixel data of a 2D image and some 
/// basic methods to manipulate it.

/// Trait or Generic?
    struct ImageProcessor<T> {
