...
public class ImageReader {
    ...
    */
    ...
    fn byte[] read_8bit_image(InputStream in) throws IOException {
    ...
    fn byte[] readcompressed_8bit_image(InputStream in) throws IOException {
        byte[] pixels = new byte[nPixels];
        int current = 0;
        byte last = 0;
    ...
    fn short[] read_16bit_Image(InputStream in) throws IOException {
    ...
    fn short[] read_compressed_16bit_image(InputStream in) throws IOException {
