...
use crate::grayscale::Gray8;
use crate::grayscale::Gray16;
use crate::grayscale::Gray32;
...
/// Read a raw file and put he data into an image stack of 8bit
    ...
    ///
pub fn read_byte_stack(height:u32,width:u32,slice:u32,filename:&String) -> ImageStack<u8,Gray8>{
...
/// Read a raw file and put he data into an image stack of 16bit (16bit not implemented)
    ...
    /// * `filename` - The name of the raw file
    //
    pub fn read_16_stack(height:u32,width:u32,slice:u32,filename:&String) -> ImageStack<u16,Gray16>{
      let buffer = get_file_as_byte_vec(filename);
...
/// Read a raw file and put he data into an image stack of 32bit
    ...
    /// * `filename` - The name of the raw file
    ///
    pub fn read_float_stack(height:u32,width:u32,slice:u32,filename:&String) -> ImageStack<f32,Gray32>{
      let buffer = get_file_as_byte_vec(filename);
