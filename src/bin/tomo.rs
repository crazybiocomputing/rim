...
// Commande : cargo run --bin sinogram -- -i "path_image" -d 256x256 -b 32 -p "path_ficher_angle" -o "path_sortie_image"

// Exemple:  cargo run --bin sinogram -- -i ./src/sino.bin -d 256x256 -b 32 -p ./src/angles.csv -o ./test
